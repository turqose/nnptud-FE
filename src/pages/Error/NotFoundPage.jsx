...
const NotFoundPage = () => {
  return (
    <section className="min-h-screen bg-gray-100 dark:bg-gray-800">
      <div className="py-8 px-4 min-h-screen mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center min-h-screen flex items-center justify-center flex-col">
